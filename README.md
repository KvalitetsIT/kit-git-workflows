...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------- |
| [argocd-diff-preview.yml](.github/workflows/argocd-diff-preview.yml)                                                                                               | Generates Argo CD diff preview, supports simple app path or App-of-Apps Helm rendering with values files, injects repo-creds for private repos, and upserts the diff as a PR comment. |
