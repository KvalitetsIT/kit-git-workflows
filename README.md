...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------- |
| [argocd-diff-preview.yml](.github/workflows/argocd-diff-preview.yml)                                                                                               | Generates Argo CD diff preview, injects repo-creds for private repos, and upserts the diff as a PR comment.          |
